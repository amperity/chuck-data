...
from src.ui.ascii_art import display_welcome_screen
...
class ChuckTUI:
    ...
    def _get_available_commands(self) -> List[str]:
        ...
        try:
            ...
            from src.command_registry import TUI_COMMAND_MAP
    ...
    def _display_paginated_sql_results(self, data: Dict[str, Any]) -> None:
        ...
        import sys
        from src.commands.sql_external_data import PaginatedSQLResult
        from src.ui.table_formatter import display_table
        from src.exceptions import PaginationCancelled

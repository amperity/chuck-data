...
def _phase_2_handle_review(
    ...
    if user_input_lower in ["launch", "yes", "y", "launch it", "go", "proceed"]:
        ...
        console.print("When you launch Stitch it will create a job in Databricks and a notebook that will show you Stitch results when the job completes.")
        console.print("Stitch will create a schema called stitch_outputs with two new tables called unified_coalesced and unified_scores.")
        console.print("The unified_coalesced table will contain the standardized PII and amperity_ids.")
        console.print("The unified_scores table will contain the links and confidence scores.")

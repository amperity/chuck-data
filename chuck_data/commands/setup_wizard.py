...
class SetupWizardOrchestrator:
    ...
    def _save_state_to_context(self, state: WizardState):
        ...
        context_data = {
            ...
            "token": state.token,
            "volume_catalog": state.volume_catalog,
            "volume_schema": state.volume_schema,
    ...
    def _load_state_from_context(self) -> Optional[WizardState]:
        ...
        try:
            ...
            loaded_state = WizardState(
                ...
                volume_catalog=context_data.get("volume_catalog"),
                volume_schema=context_data.get("volume_schema"),

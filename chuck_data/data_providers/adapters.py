...
class DatabricksProviderAdapter:
    ...
    def execute_query(
        ...
        """Execute SQL query (not implemented for Databricks adapter).
        ...
        Raises:
            NotImplementedError: Query execution not implemented
        """
        raise NotImplementedError(
            "Query execution not yet implemented for Databricks provider"
        )
